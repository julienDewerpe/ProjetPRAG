...
try {
    ...
    $mail->SMTPAuth = true;
    $mail->Username = '635942ebab7ec6a03b9b9f88d75f2958'; //username
    $mail->Password = '2884fd99608c3b4a7495699e5426f871'; //password
    $mail->SMTPSecure = 'tls';
    $mail->Port = 587; //smtp port
    
    $mail->setFrom('taha92220@gmail.com', 'entreed');
...
//ici, la suite du code utile
    ...
    echo 'Email could not be sent. Mailer Error: '. $mail->ErrorInfo;
			...
			$mail->SMTPSecure = 'tls';
			$mail->Port = 2525;
			$mail->Username='3dd9ed3f23f101' ;
			$mail->Password='1ab21e5a6e2bf5' ;
			$mail->FromName = "entre'ed";
			$mail->From='entreed@corp.com';
			$mail->AddAddress($_POST['user_email']);
			$mail->Subject="Test";
			$mail->Body=$mail_body;
			$mail->IsHTML(true);
			if(!$mail->Send()){echo $mail->ErrorInfo;}else{echo 'Mail envoyé';}*/
		}
	}
}
