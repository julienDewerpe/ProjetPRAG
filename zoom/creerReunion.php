...
try {
	...
	$query = "INSERT INTO `reunion`(`id_zoom`, `sujet`, `date`, `duree`, `description`, `mdp`, `lien`) VALUES ('$response->id','$topic','$date','$duree','$story','$mdp','$response->join_url')";
...
echo "<form action='creerReunion.php' method='post'>
 ...
 <p>Description : <textarea id='story' name='story' rows='5' cols='33' ></textarea>
 <p>Difficulté : 
